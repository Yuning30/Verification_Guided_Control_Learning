...
int main(int argc, char* argv[])
{
	...
	char const *module_name = "controller_approximation_lib_3dsys";
	...
	char const *neural_network = "3d_W";
	double err_max = 0;
	...
	ofstream result_output("./outputs/nn_3d_relu.txt");
	...
	// cout<<end_box[2].inf()<<endl;
	// cout<<end_box[0].sup()<<endl;
	// cout<<end_box[1].sup()<<endl;
	// cout<<end_box[2].sup()<<endl;
	// string NUM = argv[3];
	cnpy::npy_save("StepReach.npy", &StepReach[0], {StepReach.size()}, "w");
	return 0;
}